...
// Based on ReactBits Galaxy implementation
...
export function initGalaxy(containerId, options = {}) {
  const {
    focal = [0.5, 0.5],
    rotation = [1.0, 0.0],
    starSpeed = 0.5,
  ...
  function resize() {
    const scale = 0.5; // Render at half resolution for 4x performance boost
  ...
  function handleMouseLeave() {
    ...
    console.error('Error initializing galaxy background:', error);
    return null;
  }
}
